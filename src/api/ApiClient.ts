    ...
    responseData = {
      header: {
        ...
        venue: {
          ...
          googlePlaceId: attributes.venue_google_place_id,
          latitude: attributes.venue_latitude,
          longitude: attributes.venue_longitude,
          name: attributes.venue_name,
          postalCode: attributes.venue_postal_code,
          state: attributes.venue_state,
          street: attributes.venue_street,
          streetNumber: attributes.venue_street_number,
        },
      },
      items: items,
      tickets: tickets,
