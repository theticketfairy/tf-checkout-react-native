      ...
      <View style={styles.form}>
        ...
        >
          <Input
            ...
            onChangeText={formik.handleChange('emailConfirmation')}
            onBlur={formik.handleBlur('emailConfirmation')}
            error={
          ...
          >
            <DropdownMaterial
              ...
              selectedOption={{
                ...
                label:
                  countries.find((c) => c.id === formik.values.country)?.name ||
                  'Select Country',
              }}
              materialInputProps={{
                label: 'Country',
          ...
          >
            <DropdownMaterial
              ...
              selectedOption={{
                ...
                label:
                  states.find((s) => s.value.toString() === formik.values.state)
                    ?.label || 'Select State',
              }}
              materialInputProps={{
